        ...
        <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-10">
          ...
          <div>
            ...
            <p className="text-sm text-gray-400 leading-relaxed mb-5">
              Empowering Multan's youth with cutting-edge digital skills and professional certifications since 2018.
            </p>
          ...
          {/* Quick Links */}
          <div>
            <h4 className="text-white font-semibold mb-5" style={{ fontFamily: 'Syne, sans-serif' }}>Quick Links</h4>
          ...
          {/* Popular Courses */}
          <div>
            <h4 className="text-white font-semibold mb-5" style={{ fontFamily: 'Syne, sans-serif' }}>Popular Courses</h4>
            <ul className="space-y-3">
          ...
          {/* Contact */}
          <div>
            <h4 className="text-white font-semibold mb-5" style={{ fontFamily: 'Syne, sans-serif' }}>Get In Touch</h4>
